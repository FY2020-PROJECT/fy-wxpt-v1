 ...
 * @return String
 */
function encode($string = '', $skey = 'dsgygb') {
 ...
 * @return String
 */
function decode($string = '', $skey = 'dsgygb') {
...
function aesDecode($secretData){
    return openssl_decrypt(urldecode($secretData),'aes-128-cbc','xxxx',false,'dsgygb');
}

function aesEncode($data){
    return urlencode(openssl_encrypt($data,'aes-128-cbc','xxxx',false,'dsgygb'));
}
